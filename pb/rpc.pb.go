...
type RlncExtra struct {
	Coefficients         [][]byte `protobuf:"bytes,1,rep,name=coefficients" json:"coefficients,omitempty"`
...
type RsExtra struct {
	...
	ChunkCount           *uint32  `protobuf:"varint,2,opt,name=chunkCount" json:"chunkCount,omitempty"`
	IwantBitmap          []byte   `protobuf:"bytes,3,opt,name=iwantBitmap" json:"iwantBitmap,omitempty"`
...
func (m *RsExtra) GetIwantBitmap() []byte {
	if m != nil {
		return m.IwantBitmap
	}
	return nil
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
func (m *RsExtra) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IwantBitmap != nil {
		i -= len(m.IwantBitmap)
		copy(dAtA[i:], m.IwantBitmap)
		i = encodeVarintRpc(dAtA, i, uint64(len(m.IwantBitmap)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ChunkCount != nil {
...
func (m *RsExtra) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IwantBitmap", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IwantBitmap = append(m.IwantBitmap[:0], dAtA[iNdEx:postIndex]...)
			if m.IwantBitmap == nil {
				m.IwantBitmap = []byte{}
			}
			iNdEx = postIndex
